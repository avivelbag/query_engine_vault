...
def test_parser_select_star():
    ...
    assert ast == {"type": "select", "distinct": False, "columns": ["*"], "from": "employees", "from_alias": None, "join": None, "where": None, "group_by": [], "having": None, "order_by": [], "limit": None}
...
def test_parser_lowercase():
    ...
    assert ast == {"type": "select", "distinct": False, "columns": ["*"], "from": "orders", "from_alias": None, "join": None, "where": None, "group_by": [], "having": None, "order_by": [], "limit": None}
